...
![Code Capsules Space](./img/ccSpace.webp)
...
![Code Capsules new capsule](./img/ccNewCapsule.webp)
...
![Code Capsules new capsule scrolled](./img/ccNewCapsuleDown.webp)
...
![Code Capsules database setup](./img/ccDbSetup.webp)
...
![Code Capsules CLI](./img/ccCli.webp)
...
![Code Capsules Capsule size](./img/ccCapsuleCheap.webp)
...
![Code Capsules Install GitHub addon](./img/ccInstallGithub.webp)
...
![Code Capsules Capsule path](./img/ccCapsulePath.webp)
...
![Code Capsules Capsule command](./img/ccCapsuleCommand.webp)
...
![Code Capsules Capsule config](./img/ccCapsuleConfig.webp)
...
![Code Capsules Capsule config values from another capsule](./img/ccCapsuleConfig2.webp)
...
![Code Capsules emailer](./img/ccEmailer.webp)
